...
from .modules.simplified_stateful_rnn_model import (
...
class SimplifiedStatefulRNNPolicy(Policy):
    def __init__(self):
        super().__init__()
        battery = BatteryEnv(13, 5, 7.5)
        self.model = SimplifiedStatefulRNNModel.load_from_checkpoint(
            "bot/data/checkpoints/simplified_stateful_rnn_model.ckpt",  # placeholder
            battery=battery,
            map_location="cpu",
        )
